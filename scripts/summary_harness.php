...
foreach($xmldata->children() as $racedata) { // gets all <trackdata> children of the root element <data>

	echo '<h4>' .$racedata->racedata[$anchorNum]->posttime. '</h4>';
...
foreach($racedata->racedata->horsedata as $horsedata) { 
...
$lines=0;
	...
	echo '</table>';
ECHO "SHOULD LOOP HERE ".$anchorNum;
