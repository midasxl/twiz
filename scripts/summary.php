          ...
          echo '<div class="title">
            ...
            <thead>
              ...
              foreach($racedata->horsedata as $horsedata) { // gets <horsedata> node
                            ...
                            echo '<tr>
                            <td>'.$horsedata->program.'</td>
                            <td><input type="checkbox" class="check" /></td>
                            <td>'.$horsedata->horse_name.' ('.$weighttoday.') '.'</td>
                            <td>'.$meds."|".$blinks."|".$aelg.'|'.$scr.'</td>
                            <td>'.money_format("$%i", $dollarvalue).'</td>
                            <td>'.$strj.'/'.$strt.'</td>
                            <td>'.$wkdays.'</td>
                            <td>'.$wktext.', '.$wkrank.'/'.$wkgroup.'</td>
                            <td>'.number_format($workperc, 0, '.', '').'</td>';
                            ...
                            foreach($horsedata->ppdata as $ppdata) { // gets <ppdata> node - ends at 799
                                      ...
                                      if ($firstrow==0){
                                          ...
                                          $days2=$days;
                                          echo '<td>'.round($days).$cw.'</td>
                                          <td>'.$equilink.'</td>
                                          <td>'.number_format($raceperc, 0, '.', '').'</td>';
                                          $firstrow=999;
                                      }
                                      ...
                                      if (isset($_POST['maxRaces'])){ // closes at 694
                            ...
                            echo '<td>'.number_format($somefig1, 1, '.', '').'</td>
                            <td>'.$yes.'</td>
                            <td>'.round($combinedc2).'</td>
                            <td>'.$rsty.'</td>
                            </tr>';
                            ...
                            if($finally == 1){
                                ...
                                $somefig1=(($somefig1-15)+$racedata->todays_cls)/2;
                                echo '<td>'.number_format($somefig1, 1, '.', '').'</td>
                                <td> </td>
                                <td>'.round($combinedc2).'</td>
                                <td>'.$rsty.'</td>
